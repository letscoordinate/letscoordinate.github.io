...
In case of Smart notification, you will be able to answer to some questions and then your answers to the coordination system.
...
** It is possible to export the coordinations' informations as xlsx file

image::monitoring_screen_general_view_full.png[Monitoring screen general view]

* *Detailed view* : details about the different answers of each TSO in live

image::monitoring_screen_detailed_view.png[Monitoring screen detaild view]

=== Logging screen

This screen displays logs of the relevant informations about the coordination process:

* New cases to coordinate/validate
* Reception of answers from TSOs
...
* End because of LTTD (Last Time To Decide) reached (SOON): a coordination can stop when the deadline (LTTD) is reached.

* End because all TSOs participating in this coordination provided their answers to the question.

. RESULTS of COORDINATION : When coordination QUESTION is ended, an INFORMATIVE notification is issued to present the results of the coordination : 2 cases:
+
--
