...
image::image::ack_not_ack.png[Ack or not ack notifications]

By default, only “Not acknowledged” notifications are displayed: As soon as an user will acknowledge a notification, it will disappears based on this filter. 
