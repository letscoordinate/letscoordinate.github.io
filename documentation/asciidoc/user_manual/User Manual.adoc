...
User can decide to order the notifications in the feed by arrival date or by gravity/color : image::ordering.png[Deck ordering]
...
* Based on the color of the notifications with this button  
