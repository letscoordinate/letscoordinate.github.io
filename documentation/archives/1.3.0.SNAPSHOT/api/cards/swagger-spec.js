window.swaggerSpec={
  "swagger" : "2.0",
  "info" : {
    "description" : "Let's Coordinate Card Consumer Service",
    "version" : "1.3.0.SNAPSHOT",
    "title" : "Card Management API",
    "termsOfService" : "",
    "contact" : {
      "email" : "letscoordinate_AT_lists.lfenergy.org",
      "url" : "https://letscoordinate.github.io/"
    },
    "license" : {
  ...
  "paths" : {
    "/async/cards" : {
      "post" : {
        ...
        "description" : "Publish one or more cards to Let's Coordinate The response for this method is always a `201` status. To make sure the cards have been published, check the count returned in the body of the request.",
    ...
    "/cards" : {
      "post" : {
        "tags" : [ "cards", "creation" ],
        "summary" : "publish cards",
        "description" : "Publish one or more card to Let's Coordinate. Be careful, to know if the cards were published well, then it is necessary to consult the report returned in the body of the request (do not rely only on the response code).",
